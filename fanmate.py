"""
FAN-MATE GUI V2.23
- Only monitors en1 (correct interface for your hotspot)
...
class App:
    def __init__(self, root):
        ...
        self.footer_lbl = tk.Label(
            root,
            text=f"GUI v{GUI_VERSION}  •  Interface: en1  •  Log: Documents/FanMate_temp_vs_data.csv",
            font=FONT_TINY
        )
