...
- Logs live on ESP32. GUI pulls sealed logs to ~/Documents/FanMate_logs/.
"""

import zlib, json, threading, time, urllib.request, os, re
...
latest_config = {
    "temp": {"warning": 32.0, "panic": 34.0, "kill": 36.0, "hysteresis": 1.0},
    "boost": {
        "mode": 1,
